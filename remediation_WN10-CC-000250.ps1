<#
.SYNOPSIS
    Enables SmartScreen filter for Microsoft Edge in compliance with STIG ID WN10-CC-000250.
...
.USAGE
    Example usage:
    PS C:\> .\remediation_WN10-CC-000250.ps1
#>
...
Write-Output "SmartScreen for Microsoft Edge has been enabled."
