<#
.SYNOPSIS
    Disables Windows Game Recording and Broadcasting in compliance with STIG ID WN10-CC-000252.
...
.USAGE
    Example usage:
    PS C:\> .\remediation_WN10-CC-000252.ps1
#>
...
Write-Output "Windows Game Recording and Broadcasting has been disabled."
