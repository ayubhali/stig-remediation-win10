<#
.SYNOPSIS
    Enables command line data logging in process creation events in compliance with STIG ID WN10-CC-000066.
...
Write-Output "Command line data will now be included in process creation events."
